...
public class PacketSpawnVehicul implements IMessage {
    private String prenom,nom,sex,age;
    private int player,rib,cb;
    private double argent;

    public PacketSpawnVehicul(){}

    public PacketSpawnVehicul(EntityPlayer player, String nom, String prenom, String sex, String age, Double Argent) {
    ...
    public static class handler implements IMessageHandler<PacketSpawnVehicul,IMessage> {
        @Override
        public IMessage onMessage(PacketSpawnVehicul message, MessageContext ctx) {
