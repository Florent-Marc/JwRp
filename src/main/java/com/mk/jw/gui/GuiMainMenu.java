...
public class GuiMainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(Minecraft.getMinecraft().fontRenderer,TextFormatting.GREEN + "Connection en cour !", this.width / 2 , this.height-20, 0);
    }
